	...
	<div style="padding-top: 2%; text-align: center;">
		...
		<ul Style="list-style-type: none;">
			<c:forEach items="${selectOrgs}" var="org">
				...
				<div class="table-white shadow-sm p-3 mb-5  rounded">
					...
					<li><a href="${itemDetailsUrl }">${org.name}</a> <br>
						...
						<p>Phone: ${org.phone}</p> <a href="${itemDetailsUrl }"><button
								type="button" class="btn btn-outline-primary">Help</button></a></li>
				</div>
			</c:forEach>
		</ul>
	</div>
